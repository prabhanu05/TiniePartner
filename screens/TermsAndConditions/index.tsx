    ...
    const navigateHandler = () => {
        if (!terms) {
            Alert.alert(
                ...
                'In order to register account with us, you must agree to our terms and conditions.'
            );
            return;
        }
            ...
            <ScrollView contentContainerStyle={styles.list}>
                <View style={styles.para}>
                    ...
                    <Text style={styles.body}>
                        ...
                        tinie app won’t work properly or at all. The app does
                        use third-party services that declare their Terms and
                        ...
                        charges. In using the app, you’re accepting
                        ...
                        that we assume that you have received permission from
                        the bill payer for using the app.{'\n\n'}Along the same
                        lines, tinie business private limited cannot always take
                        ...
                        Service, tinie business private limited cannot accept
                        responsibility.{'\n'}With respect to tinie business
                        private limited’s responsibility for your use of the
                        app, when you’re using the app, it’s important to bear
                        ...
                        it available to you. tinie business private limited
                        accepts no liability for any loss, direct or indirect,
                        you experience as a result of relying wholly on this
                        functionality of the app.{'\n'}At some point, we may
                        wish to update the app. The app is currently available
                        on Android – the requirements for the system(and for any
                        additional systems we decide to extend the availability
                        of the app to) may change, and you’ll need to download
                        the updates if you want to keep using the app. tinie
                        business private limited does not promise that it will
                        always update the app so that it is relevant to you
                        and/or works with the Android version that you have
                        installed on your device. However, you promise to always
                        accept updates to the application when offered to you,
                        We may also wish to stop providing the app, and may
                        terminate use of it at any time without giving notice of
                        termination to you. Unless we tell you otherwise, upon
                        any termination, (a) the rights and licenses granted to
                ...
                <Pressable style={styles.checkboxRow} onPress={toggleHandler}>
